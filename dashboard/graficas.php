...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Mi equipo - Gráficas</title>
        ...
        <link rel="stylesheet" href="morris.js-0.5.1/lib/example.css">
              ...
              <!--left navigation end-->
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        ...
                        <div id="website-stats" style="height: 320px;" class=""></div>


                        <div class="row">
                            <div class="col-lg-6">

                                    <div id="website-stats1" style="height: 320px;" class=""></div>
                            </div>
