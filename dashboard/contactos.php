                        	...
                        	<div class="col-md-4">
                        		<div class="text-center card-box">
                                    ...
                                    <div class="member-card">
                                        <span class="user-badge bg-warning">Delantero</span>
                                        <div class="thumb-xl member-thumb m-b-10 center-block">
                                            <img src="logo_jaguar.jpg" class="img-circle img-thumbnail" alt="profile-image">
                                            <i class="mdi mdi-information-outline member-star text-success" title="verified user"></i>
                                        </div>

                                        <div class="">
                                            <h4 class="m-b-5">Marcelo Barrón</h4>
                                            <span> <a href="#" class="text-pink">1530200@upv.edu.mx</a> </span></p>
                                        </div>
                            ...
                            <div class="col-md-4">
                          		<div class="text-center card-box">
                                      ...
                                      <div class="member-card">
                                          ...
                                          <div class="">
                                              <h4 class="m-b-5">Armando Hernández</h4>
                                              <span> <a href="#" class="text-pink">1530234@upv.edu.mx</a> </span></p>
                                          </div>
                              ...
                              <div class="col-md-4">
                            		<div class="text-center card-box">
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="member-card">
                                            <span class="user-badge bg-custom">Medio</span>
                                            <div class="thumb-xl member-thumb m-b-10 center-block">
                                                <img src="logo_jaguar.jpg" class="img-circle img-thumbnail" alt="profile-image">
                                                <i class="mdi mdi-information-outline member-star text-success" title="verified user"></i>
                                            </div>
                                            ...
                                            <div class="">
                                                <h4 class="m-b-5">David Tovias</h4>
                                                <span> <a href="#" class="text-pink">1530278@upv.edu.mx</a> </span></p>
                                            </div>
                          ...
                          <div class="col-md-4">
                            <div class="text-center card-box">
                                    ...
                                    <div class="member-card">
                                        ...
                                        <div class="">
                                            <h4 class="m-b-5">Martín Pérez</h4>
                                            <span> <a href="#" class="text-pink">1530130@upv.edu.mx</a> </span></p>
                                        </div>
                            ...
                            <div class="col-md-4">
                          		<div class="text-center card-box">
                                      ...
                                      <div class="clearfix"></div>
                                      <div class="member-card">
                                          <span class="user-badge bg-warning">Defensa</span>
                                          <div class="thumb-xl member-thumb m-b-10 center-block">
                                              <img src="logo_jaguar.jpg" class="img-circle img-thumbnail" alt="profile-image">
                                              <i class="mdi mdi-information-outline member-star text-success" title="verified user"></i>
                                          </div>
                                          ...
                                          <div class="">
                                              <h4 class="m-b-5">Pancho López</h4>
                                              <span> <a href="#" class="text-pink">1530321@upv.edu.mx</a> </span></p>
                                          </div>
                              ...
                              <div class="col-md-4">
                            		<div class="text-center card-box">
                                        ...
                                        <div class="member-card">
                                            ...
                                            <div class="">
                                                <h4 class="m-b-5"></h4>
                                                <h4 class="m-b-5">Cristian Echartea</h4>
                                                <span> <a href="#" class="text-pink">1530200@upv.edu.mx</a> </span></p>
                                            </div>
