                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                                    ...
                                    <h4 class="header-title m-t-0">Dar de baja jugador</h4>
                                    <p class="text-muted font-13 m-b-10">
                                        Ingresa la matrícula del jugador que será dado de baja
                                    </p>

                                    <div class="p-20 m-b-20">
                                        <form action="#" class="form-validation">
                                            <div class="form-group">
                                                <label for="userName">Matrícula<span class="text-danger">*</span></label>
                                                <input type="text" name="matricula" parsley-trigger="change" required
                                                       placeholder="Ingresar matrícula" class="form-control" id="matricula">
                                            </div>

                                            <div class="form-group text-left m-b-0">
                                              <br>
                                              <h4 class="m-b-30 m-t-0 header-title">Motivos por los que es baja del equipo</h4>
                                              <div class="summernote">
                                                <h4>El jugador fue dado de baja por...</h4>
                                                                    <ul>
                                                                        <li>
                                                                            Nunca asisitió a ningún partido
                                                                        </li>
                                                                        <li>
                                                                            Nunca pagó el arbitraje
                                                                        </li>
                                                                        <li>
                                                                            Está bien tronco
                                                                        </li>
