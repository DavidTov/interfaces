                            ...
                            <div class="col-lg-6">
                                <div class="p-20 m-b-20">
                                    ...
                                    <p class="text-muted font-13 m-b-10">
                                          Ingresa el nombre de usuario y contraseña del nuevo administrador
                                    </p>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" required parsley-type="text" class="form-control"
                                                           id="inputEmail3" placeholder="Ingresa nombre de usuario">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="hori-pass1" class="col-sm-4 form-control-label">Contraseña<span class="text-danger">*</span></label>
                                                <div class="col-sm-7">
                                                    <input id="hori-pass1" type="password" placeholder="Ingresar contraseña" required
                                                           class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input data-parsley-equalto="#hori-pass1" type="password" required
                                                           placeholder="Confirmar" class="form-control" id="hori-pass2">
                                                </div>
                                            </div>
