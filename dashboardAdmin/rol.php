              ...
              <!--left navigation end-->
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title m-t-0">Hacer el rol de juegos</h4>
                            </div>
                        </div> <!-- end row -->
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div id="external-events" class="m-t-20">
                                                        <br>
                                                        <p class="text-muted">Arrastra cualquiera de los cuadros para rolar un partido en una fecha y hora específica</p>
                                                        <div class="external-event bg-success" data-class="bg-success">
                                                            <i class="mdi mdi-checkbox-blank-circle m-r-10 vertical-middle"></i>Desliza hacia el calendario
                                                        </div>
